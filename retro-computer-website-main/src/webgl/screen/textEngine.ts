...
export default function ScreenTextEngine(
  ...
  function clear() {
    // Remove all children except the caret and base meshes
    const childrenToRemove: THREE.Object3D[] = [];
    rootGroup.children.forEach((child) => {
      if (child !== textColorMesh && child !== textBlackMesh && child !== textBgMesh && child !== caret) {
    ...
    // Clear geometries
    textColorMesh.geometry.dispose();
    textBlackMesh.geometry.dispose();
    textBgMesh.geometry.dispose();
    textColorMesh.geometry = new TextGeometry("", {
      font: h1Font.font as any,
      size: h1Font.size,
      height: 0.0001,
      curveSegments: 12,
    ...
    textBlackMesh.geometry = new TextGeometry("", {
      font: h1Font.font as any,
      size: h1Font.size,
      height: 0.0001,
      curveSegments: 12,
    ...
    textBgMesh.geometry = new THREE.PlaneBufferGeometry(0, 0);
    updateCaret(0);
  }
